...
def load_multicam(dataset, group_name, section_number, optional_frames=None):
    ...
    print(cameras[0][0][0][0][0][0][0][0])
    print('cameras[0][0][0][0][0][0][0]["translate"]')
    print(len(cameras[0][0][0][0][0][0][0]["translate"]))
    print(cameras[0][0][0][0][0][0][0]["translate"].shape)
    print(cameras[0][0][0][0][0][0][0]["translate"].dtype)
    print(cameras[0][0][0][0][0][0][0]["translate"])
